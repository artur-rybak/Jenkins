...
//                OSUtils.killProcess("chromedriver.exe");
                 ...
                 */
                String chromePath = String.format("C:/Program Files/chromedriver/chromedriver.exe", System.getProperty("user.dir"));
                ...
                options.addArguments("--disable-logging", String.format("--lang=%s", lang));
